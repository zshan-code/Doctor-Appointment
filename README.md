...
## Clone The Project
git clone https://github.com/zshan-code/Doctor-Appointment.git
...
3. Paste the database URL into the .env file.
...
3. Copy the generated password and paste it into .env as EMAIL_PASS.

### Setup Cloudinary to Upload Image
1. Create a Cloudinary Account.
2. Login and copy all the credentials.
...
## Contact
zshan: [https://github.com/zshan-code](https://github.com/zshan-code)
